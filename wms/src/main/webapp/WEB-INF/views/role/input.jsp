              ...
              <tr>
                <td>
                  <s:select list="#permissions" listKey="id" listValue="name"
                            multiple="true" cssClass="ui_multiselect01 all_selectList"/>
                </td>
                <td align="center">
                ...
                <td>
                  <s:select list="role.permissions" name="role.permissions.id" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 selected_selectList"/>
                </td>
              </tr>
            </table>
          </td>
              ...
              <tr>
                <td>
                  <s:select list="#menus" listKey="id" listValue="name"
                            multiple="true" cssClass="ui_multiselect01 all_menus_selectList"/>
                </td>
                <td align="center">
                ...
                <td>
                  <s:select list="role.menus" name="role.menus.id" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 selected_menus_selectList"/>
                </td>
              </tr>
            </table>
          </td>
