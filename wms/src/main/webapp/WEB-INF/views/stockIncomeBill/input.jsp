...
<!-- ============================================================ -->
<s:form name="editForm" action="stockIncomeBill_saveOrUpdate.action" method="post" id="editForm">
  <s:hidden name="stockIncomeBill.id"/>
  <div id="container">
    <div id="nav_links">
      <span style="color: #1A5CC6;">到货入库单编辑</span>
      <div id="page_close">
        <a>
    ...
    <div class="ui_content">
      <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
        ...
        <tr>
          ...
          <td class="ui_text_lt">
            <s:select list="#depots" name="stockIncomeBill.depot.id" listKey="id" listValue="name" cssClass="ui_select03"/>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td class="ui_text_lt">
            <s:date name="stockIncomeBill.vdate" format="yyyy-MM-dd" var="ov"/>
            <s:textfield name="stockIncomeBill.vdate" cssClass="ui_input_txt02" value="%{ov}"/>
          </td>
        </tr>
